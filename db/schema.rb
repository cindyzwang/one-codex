...
ActiveRecord::Schema.define(version: 20170325063417) do
  ...
  create_table "nick_names", force: :cascade do |t|
    t.string   "name"
  ...
  create_table "scientific_names", primary_key: "taxonomy_id", id: :integer, force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.string   "ancestry"
    t.index ["ancestry"], name: "index_scientific_names_on_ancestry", using: :btree
  end
